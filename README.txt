...
= 1.6.1 =
* Fixed minor issue where the story list shortcode could produce an error
* Added filter so story list sort order can be overridden with a functionality plugin
...
= 1.5 =
* Added the ability to set footer text for story posts, along with the option to show it or not
* Updated cmb2 and plugin-update-checker to the newest versions
